...
- Verification: `pnpm i18n:check` green at 15 namespaces / 1176 zh keys / 1176 ru keys / 100% ru coverage / 2 line exemptions; dsh-i18n typecheck, test and build green; aggregate regenerated with the `web-ui-i18n` row and `pnpm aggregate:check` green. The bundle row change requires a user-side DSH restart before Русский appears under Settings -> General -> Language.
