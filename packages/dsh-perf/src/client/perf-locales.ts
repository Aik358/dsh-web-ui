...
export const zh = {
  ...
  'settings.renderDegradeHint': '超重助手消息(>20KB)延迟终态渲染(懒高亮)：高亮尖峰移出回合结束热路径，样式与官方一致。',
...
export const en = {
  ...
  'settings.renderDegradeHint': 'Heavy assistant messages (>20KB) finalize their highlight lazily, moving the spike off the turn-end hot path; the look stays identical to official.',
