...
export const zh = {
  ...
  'settings.renderDegradeHint': '超重助手消息(>20KB)折叠与懒高亮，消除开窗/回合结束的代码高亮尖峰。',
...
export const en = {
  ...
  'settings.renderDegradeHint': 'Collapse and lazily highlight heavy assistant messages (>20KB), removing the highlight spike at window open and turn end.',
