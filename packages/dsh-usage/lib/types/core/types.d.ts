...
export declare function emptyTotals(): UsageTokenTotals;
/** Add `right` into `left` in place. */
export declare function addTotals(left: UsageTokenTotals, right: Readonly<UsageTokenTotals>): UsageTokenTotals;
